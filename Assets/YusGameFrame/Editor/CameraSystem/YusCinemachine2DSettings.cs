...
public static class YusCinemachine2DSettings
{
    ...
    [MenuItem(YusGameFrameEditorMenu.Root + "Systems/Camera/Cinemachine 2D/Control Panel")]
    public static void OpenPanel()
    {
        YusCinemachine2DSettingsWindow.ShowWindow();
    }

    [MenuItem(YusGameFrameEditorMenu.Root + "Systems/Camera/Cinemachine 2D/Enable")]
    ...
    [MenuItem(YusGameFrameEditorMenu.Root + "Systems/Camera/Cinemachine 2D/Enable", true)]
    private static bool ValidateEnable()
    {
        return HasCinemachineInstalled() && !IsDefineEnabled();
    }

    [MenuItem(YusGameFrameEditorMenu.Root + "Systems/Camera/Cinemachine 2D/Disable")]
    ...
    [MenuItem(YusGameFrameEditorMenu.Root + "Systems/Camera/Cinemachine 2D/Disable", true)]
