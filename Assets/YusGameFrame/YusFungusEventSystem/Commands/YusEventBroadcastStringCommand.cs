...
[CommandInfo("YusEvent", "Broadcast (String)", "Broadcast a YusEventSystem event with a string payload.")]
[AddComponentMenu("")]
public class YusEventBroadcastStringCommand : Command
{
    ...
    [Tooltip("Event key used by YusEventSystem (e.g. YusEvents.OnLanguageChanged)")]
    [SerializeField] protected StringData eventName = new StringData("");

    [Tooltip("String payload")]
    [SerializeField] protected StringData payload = new StringData("");
    ...
    public override bool HasReference(Variable variable) => eventName.stringRef == variable || payload.stringRef == variable;
