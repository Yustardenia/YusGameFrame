...
[CommandInfo("YusEvent", "Broadcast (Bool)", "Broadcast a YusEventSystem event with a bool payload.")]
[AddComponentMenu("")]
public class YusEventBroadcastBoolCommand : Command
{
    ...
    [Tooltip("Bool payload")]
    [SerializeField] protected BooleanData payload = new BooleanData(false);
    ...
    public override bool HasReference(Variable variable) => eventName.stringRef == variable || payload.booleanRef == variable;
